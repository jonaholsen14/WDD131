...
function renderTasks(tasks) {
    ...
    // Clear the list before rendering to avoid duplicating tasks
    list.innerHTML = '';

    // Check if tasks array is properly populated
    console.log(tasks);  // Debugging: See the contents of tasks
